            ...
            <table class="table">
                ...
                <tbody>
                    ...
                    ORDER BY
                        ...
                        JOIN bandara AS bandara_tujuan ON rute.ID_BandaraTujuan = bandara_tujuan.ID
                        JOIN maskapai ON jadwal.ID_Pesawat = maskapai.ID
                        JOIN tiket ON jadwal.ID = tiket.ID_Jadwal
                        ORDER BY
                            jadwal.ID");
                    }
                                    ...
                                    <div class="modal-body">
                                        ...
                                        <div>
                                            ...
                                            <select name="kelas" id="kelas" required>
                                                <?php
                                                $id_jadwal = $info['No'];
                                                $queryKelas = "SELECT DISTINCT kelas FROM kursi WHERE id_jadwal = $id_jadwal";
                                                $hasilKelas = mysqli_query($koneksi, $queryKelas);
                                                while ($dataKelas = mysqli_fetch_assoc($hasilKelas)) {
